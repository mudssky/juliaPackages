...
# ╔═╡ 431293af-ca3b-4904-91a5-ddd5b8a6d19c
...
Probabilities=ingredients("../src/Probabilities.jl").Probabilities
...
begin
	xmax=5
	plot(0:xmax,Probabilities.Poisson_Distribution(0:xmax,(2000*0.001)))
end

# ╔═╡ 6b077a31-6c28-4b62-85c4-f2126f412e27
Probabilities.Poisson_Distribution(0:200,(2000*0.001))

# ╔═╡ 78628c40-22a6-403a-a74a-ecf70b260777
Probabilities.Normal_Distribution_pdf(0:0.01:1,0,1)

# ╔═╡ 2fca38f3-5105-4193-aa58-d35fba8c14d8
begin
	xrange=-5:0.1:5
	plot(xrange,Probabilities.Normal_Distribution_pdf(xrange,0,1))
end

# ╔═╡ c8f88808-c914-46df-86fb-fab0880aef37
let
	xrange=0:0.1:10
	plot(xrange,Probabilities.Exponential_Distribution(xrange,2))
end
